...
// CONCATENATED MODULE: ./store/reducers/postReducer.js
...
const store_reducer = Object(external_redux_["combineReducers"])({
  postReducer: reducer
});
...
const withRedux = (PageComponent, {
  ...
  if (ssr || PageComponent.getInitialProps) {
    WithRedux.getInitialProps = async context => {
      ...
      return with_redux_store_objectSpread(with_redux_store_objectSpread({}, pageProps), {}, {
...
// EXTERNAL MODULE: ./styles/editpost.css
var editpost = __webpack_require__("KDZ4");

// EXTERNAL MODULE: ./styles/addpost.css
var addpost = __webpack_require__("rdmk");
...
function Layout({
  ...
  return Layout_jsx("div", null, children);
}

/* harmony default export */ var components_Layout = (withRedux(Layout));
...
class _app_MyApp extends app_default.a {
  render() {
    ...
    return _app_jsx(components_Layout, null, _app_jsx(Component, pageProps));
  }
